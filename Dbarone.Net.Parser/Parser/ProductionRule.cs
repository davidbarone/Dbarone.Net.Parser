...
/// <summary>
/// Specifies a single production rule in a grammar.
/// </summary>
public class ProductionRule : ILoggable
{
    ...
    public Action<object, LogArgs> LogHandler { get; set; } = (object obj, LogArgs logArgs) => { };
    ...
    /// <summary>
    /// Constructor for the ProductionRule class.
    /// </summary>
    /// <param name="name">The name of the production rule.</param>
    /// <param name="symbols">The symbols in the production rule.</param>
    ...
    public bool IsEnumeratedSymbol(string alias)
    {
        ...
        if (!found)
        {
            throw new Exception($"ProductionRule.IsEnumeratedSymbol(): Symbol {alias} does not exist in production rule {this.Name}.");
        }
    ...
    /// <summary>
    /// Goes through all symbols in production rule, creating the appropriate result object:
